...
@Component
public class ForecastWeather extends WeatherBotFacade implements States {
    @Override
    public void executeState(Update update, Long chatId, String messageText, String userFirstName) {
        ...
        // погода для стандартного города
            ...
            sendMessage(update, messageGenerator.generateForecastWeather(chatConfigService.getCity(chatId)));
        }
    }
}
